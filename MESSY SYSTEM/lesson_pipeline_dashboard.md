...
2) Copy relevant key_points/images into the Day A/B shell:
   - Day A: Myth Retelling; Myth in Art; **Ritual + Material Object: element→myth→ritual→object/form→embodied action; freq/radius; why it belongs)**; Art Technique; Practice; Hands-On; Wrap up through Civic Project Exit Ticket "State Day A Thesis"
   - Day B: Bridge; Geometric Element's Metaphor as Functional **Design-in-Use (functionality + transformations + physics + adoption)**; Structural Decomposition; Practice; Hands-On Model/Test; Wrap; Exit Ticket.
